...
> Extracted from `https://kingdomofarcane.com` on April 21, 2026
> 201 elements analyzed
...
|------|-----|-----|-----|-------------|
| Primary | `#00d9ff` | rgb(0, 217, 255) | hsl(189, 100%, 50%) | 205 |
| Secondary | `#ffb800` | rgb(255, 184, 0) | hsl(43, 100%, 50%) | 1 |
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#e8e8f0` | hsl(240, 21%, 93%) | 92 |
| `#000000` | hsl(0, 0%, 0%) | 80 |
| `#9ca3af` | hsl(218, 11%, 65%) | 14 |
| `#0a0a0f` | hsl(240, 20%, 5%) | 5 |
| `#ffffff` | hsl(0, 0%, 100%) | 2 |
| `#c8c8d8` | hsl(240, 17%, 82%) | 2 |
| `#4b5563` | hsl(215, 14%, 34%) | 1 |
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#00d9ff` | border, text, background | 205 |
| `#e8e8f0` | text | 92 |
| `#000000` | text, background | 80 |
| `#9ca3af` | text | 14 |
...
- **ui-sans-serif** — used for body (77 elements)
...
`400` (178x), `500` (19x), `600` (3x), `700` (1x)
...
|----------|-----------|-------------|-------------|-----------|-------------|
| mobile (375px) | 16px | No | 2 | No | 17996px |
...
- **custom** (26 uses) — `cubic-bezier(0.4, 0, 0.2, 1)`
